        ...
        <section className="wrapper py-20">
          <AnimateIn>
            <div className="flex flex-wrap gap-4">
              <Link href="/v2" className="btn-fill text-[11px] uppercase tracking-[0.2em] border border-[var(--color-text)] px-7 py-3.5">
                View the portfolio
              </Link>
              <Link href="/v2/resume" className="text-[11px] uppercase tracking-[0.2em] border border-[var(--color-border)] px-7 py-3.5 text-[var(--color-text-muted)] hover:border-[var(--color-text)] hover:text-[var(--color-text)] transition-all">
                View resume
              </Link>
              <Link href="/v2/contact" className="text-[11px] uppercase tracking-[0.2em] border border-[var(--color-border)] px-7 py-3.5 text-[var(--color-text-muted)] hover:border-[var(--color-text)] hover:text-[var(--color-text)] transition-all">
                Get in touch
              </Link>
            </div>
          </AnimateIn>
