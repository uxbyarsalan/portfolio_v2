    ...
    <>
      ...
      <main>
        ...
        <section className="wrapper pt-16 pb-0">
          <AnimateIn>
            <Link href="/v2/making-of" className="group block bg-[var(--color-bg-card)] hover:bg-[var(--color-bg-card-hover)] rounded-2xl p-8 md:p-10 transition-all duration-500">
