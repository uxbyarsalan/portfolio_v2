        ...
        <section className="wrapper py-16 border-t border-[var(--color-border)]">
          <AnimateIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[{ title: "Punjab AQI", subtitle: "Environmental monitoring", href: "/v2/work/aqi" }, { title: "City Watch", subtitle: "Surveillance platform", href: "/v2/work/city-watch" }, { title: "Maryam Ki Dastak", subtitle: "Doorstep government services", href: "/v2/work/dastak" }].map((p) => (
