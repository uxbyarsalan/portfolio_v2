    ...
    <>
      ...
      <main>
        <div className="wrapper pt-28 md:pt-36">
          <AnimateIn><Link href="/v2/#work" className="nav-link text-[11px] uppercase tracking-[0.2em] text-[var(--color-text-subtle)] hover:text-[var(--color-text)] transition-colors">&larr; All projects</Link></AnimateIn>
        </div>
        ...
        <section className="wrapper py-16 border-t border-[var(--color-border)]">
          <AnimateIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[{ title: "Maryam Ki Dastak", subtitle: "Doorstep government services", href: "/v2/work/dastak" }, { title: "Punjab Jobs", subtitle: "Employment platform redesign", href: "/v2/work/punjab-jobs" }, { title: "Employee Self Service", subtitle: "Workplace community app", href: "/v2/work/ess" }].map((p) => (
