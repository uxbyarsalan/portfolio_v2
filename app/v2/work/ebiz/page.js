        ...
        <section className="wrapper py-16 border-t border-[var(--color-border)]">
          <AnimateIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[{ title: "Maryam Ki Dastak", subtitle: "Doorstep government services", href: "/v2/work/dastak" }, { title: "Punjab Jobs", subtitle: "Employment platform redesign", href: "/v2/work/punjab-jobs" }, { title: "Punjab AQI", subtitle: "Environmental monitoring", href: "/v2/work/aqi" }].map((p) => (
