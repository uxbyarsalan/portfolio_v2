        ...
        <section className="wrapper py-16 border-t border-[var(--color-border)]">
          <AnimateIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[{ title: "Employee Self Service", subtitle: "Workplace community app", href: "/v2/work/ess" }, { title: "PITB Official", subtitle: "Government portal redesign", href: "/v2/work/pitb-official" }, { title: "City Watch", subtitle: "Surveillance platform", href: "/v2/work/city-watch" }].map((p) => (
