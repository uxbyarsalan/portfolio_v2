        ...
        <section className="wrapper py-16 border-t border-[var(--color-border)]">
          <AnimateIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[{ title: "PITB Official", subtitle: "Government portal redesign", href: "/v2/work/pitb-official" }, { title: "Punjab AQI", subtitle: "Environmental monitoring", href: "/v2/work/aqi" }, { title: "Maryam Ki Dastak", subtitle: "Doorstep government services", href: "/v2/work/dastak" }].map((p) => (
