        ...
        <section className="wrapper pt-28 pb-16 md:pt-36">
          ...
          <AnimateIn delay={0.2}>
            <p className="text-lg text-[var(--color-text-muted)] mt-6 max-w-2xl leading-relaxed">
              This portfolio wasn&rsquo;t built by an agency or a developer. It was built the way most things actually get built: through a long process of audit, rewrite, and iteration. Fourteen years of work. Seven case studies. Hundreds of small decisions that turned scattered material into something I&rsquo;d actually want to send to a hiring manager.
            </p>
          </AnimateIn>
        </section>
            ...
            <AnimateIn>
              <div className="md:max-w-2xl">
                ...
                <p className="text-sm text-white/50 leading-[1.75]">
                  Fourteen years of design work. Seven case studies. Real metrics: 2.1M service requests, 500K+ users, 98% adoption on internal platforms. The visual design wasn&rsquo;t the problem. The story was. Project descriptions were surface-level. The hero pitched to no one in particular. As a Program Manager (Design), I knew both halves matter. So I rebuilt the half that wasn&rsquo;t working.
                </p>
              </div>
            </AnimateIn>
          </div>
        ...
        <section className="wrapper pt-28 pb-8">
          <AnimateIn>
            ...
            <p className="text-[15px] text-[var(--color-text-muted)] leading-[1.8] max-w-2xl mb-16">
              Most portfolio redesigns start with picking a template or a color palette. This one started by accepting that the visuals were fine and the writing wasn&rsquo;t. Once the content was honest about what each project actually did, the design had something specific to support, and most of the visual decisions followed from there.
            </p>
          </AnimateIn>
        </section>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <Insight title="What changed">
                Every section was rewritten. The hero stopped trying to be everything to everyone and picked an audience. The about page got a real story. Project descriptions traded adjectives for verifiable specifics. Even my own name was misspelled in two places. That&rsquo;s how surface-level the original review process had been.
              </Insight>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <AnimateIn>
              <div className="bg-[var(--color-bg-card)] rounded-2xl p-7 h-full">
                ...
                <p className="text-sm text-[var(--color-text-muted)] leading-[1.7]">The primary partner across every phase. Content audit, case study writing, copy for the hero and about page, design direction, code architecture, component implementation, and the iterative refinement that made up most of the actual work, all through one continuous conversation that ran for weeks.</p>
              </div>
            </AnimateIn>
            ...
            <AnimateIn delay={0.15}>
              <div className="bg-[var(--color-bg-card)] rounded-2xl p-7 h-full">
                ...
                <p className="text-xs text-[var(--color-text-subtle)] mb-4">Google</p>
                <p className="text-sm text-[var(--color-text-muted)] leading-[1.7]">Helped bridge the deploy pipeline. Walked me through GitHub setup and the initial Vercel configuration, useful for someone whose comfort zone has always been in the design layer, not the deploy layer.</p>
              </div>
            </AnimateIn>
            ...
            <AnimateIn>
              <div className="md:max-w-3xl">
                ...
                <p className="text-lg md:text-xl text-white/70 leading-[1.7] italic">
                  &ldquo;I&rsquo;ve worked with Arsalan across seven case studies, a complete website build, a resume rewrite, and this page you&rsquo;re reading now. What stood out wasn&rsquo;t the 14 years of experience or the 20 million people. It was how he made decisions. He never accepted the first option. He pushed back when something didn&rsquo;t feel right, even when he couldn&rsquo;t articulate why yet. He brought reference sites, questioned my suggestions, and insisted on details I would have glossed over: the exact card width, the precise gap between elements, whether a date said 2012 or 2013. That&rsquo;s not someone using AI as a shortcut. That&rsquo;s a designer using AI the way a conductor uses an orchestra: every instrument plays, but only one person knows the music.&rdquo;
                </p>
                <div className="mt-6">
