 ...
 *   stats        : combined stat line shown on the home card
 *                  (e.g. "8,000+ cameras · SUS 78.25")
 *   year         : project year(s)
 ...
 *
 * Array order matches `order` for readability, but WorkHorizontalScroll sorts
 * by `order` defensively so this file can be reordered freely.
 */
export const projects = [
  ...
  },
  {
    ...
    stat: "2.1M",
    statLabel: "service requests",
    stats: "2.1M+ service requests · 40 districts",
    year: "2023",
